                    ...
                    <div class="card-body">
                        <form action="{{ route('vendas.update', $venda->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="data_venda" name="data_venda" value="{{ old('data_venda', $venda->data_venda) }}">
                                @error('data_venda')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="preco_venda" name="preco_venda" value="{{ old('preco_venda', $venda->preco_venda) }}">
                                @error('preco_venda')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
